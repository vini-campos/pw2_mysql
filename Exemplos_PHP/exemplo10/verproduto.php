...
<title> Semana 01 - Exemplo 10 </title>
<body>
<h3>Semana 01 - Exemplo 10 - Detalhes do Produto</h3>
<?php
	...
	echo "<b>Data: </b>".substr($dados['data'], 8, 2).'/'.substr($dados['data'], 5, 2).'/'.substr($dados['data'], 0, 4)."<br><br>";	
